...
try:
    ...
    py_logging.warning("Could not initialize Google Cloud Logging. Falling back to standard Python logger.")
    class FallbackLogger:
        def log_struct(self, info, severity="INFO"):
            py_logging.log(getattr(py_logging, severity, py_logging.INFO), str(info))
